...
export class ProductIds extends jspb.Message { 
    clearIdsList(): void;
    getIdsList(): Array<string>;
    setIdsList(value: Array<string>): ProductIds;
    addIds(value: string, index?: number): string;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): ProductIds.AsObject;
    static toObject(includeInstance: boolean, msg: ProductIds): ProductIds.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: ProductIds, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): ProductIds;
    static deserializeBinaryFromReader(message: ProductIds, reader: jspb.BinaryReader): ProductIds;
}

export namespace ProductIds {
